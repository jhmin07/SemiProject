...
$(document).ready(function() {
   ...
   IMP.init('imp33718714');  // 중요!!  아임포트에 가입시 부여받은 "가맹점 식별코드". 
   ...
   IMP.request_pay({
       ...
       name : '${requestScope.name}',	 // 코인충전 또는 order 테이블에 들어갈 주문명 혹은 주문 번호. (선택항목)원활한 결제정보 확인을 위해 입력 권장(PG사 마다 차이가 있지만) 16자 이내로 작성하기를 권장
       amount : '100',	  // '${requestScope.sumtotalPrice}'  결제 금액 number 타입. 필수항목. 
